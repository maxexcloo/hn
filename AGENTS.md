...
**Status**: Active
**Language**: JavaScript (Node.js 22.12+)
...
- **Formatting**: Prettier; run `mise run fmt` before commits
...
# Lint
mise run lint            # JavaScript syntax checks

# Setup
mise run setup           # Install locked dependencies

# Test
mise run test            # Node.js tests
```
...
- **fmt**: Format project files with Prettier
- **lint**: Check JavaScript syntax
...
- **Frontend**: JavaScript (Node.js 22.12+)
- **Testing**: Node.js built-in test runner

---

_Development guide for the HN open source project._
